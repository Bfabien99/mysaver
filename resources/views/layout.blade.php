        ...
        <nav class="bg-gray-800">
            ...
            <div class="md:hidden" id="mobile-menu">
                <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                    <!-- Current: "block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white", Default: "block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white" -->
                    @auth()
                        <a href="{{ route('dashboard') }}"
